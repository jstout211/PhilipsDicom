...
def convert_dicom(dicom_file, output_folder):
    ...
    mcverter_input="mcverter -o {0} -f {1}  -d -n -u -F -PatientName,+PatientId,-SeriesDate,-SeriesTime,-StudyId,-StudyDescription,+SeriesNumber,-SequenceName,+ProtocolName,-SeriesDescription {2}".format(output_folder, 'fsl', dicom_file)      
